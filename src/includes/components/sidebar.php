    ...
    <nav id="sidebar" class="d-flex flex-column">
      <a href="#" class="nav-link profile-icon" title="Profile">
        <img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" alt="User" />
      </a>
      <?php include 'src/includes/submenus/profile_submenu.php'; ?>
  <a href="#" class="nav-link active dashboard-icon" title="Dashboard"><i class="bi bi-pie-chart-fill"></i></a>
      <?php include 'src/includes/submenus/dashboard_submenu.php'; ?>
  <a href="#" class="nav-link tshirt-icon" title="Products"><i class="bi bi-tags"></i></a>
      <a href="#" class="nav-link fulfillment-icon" title="Delivery"><i class="bi bi-truck"></i></a>
  ...
  <?php include 'src/includes/submenus/shipping_submenu.php'; ?>
  <a href="#" class="nav-link" title="History"><i class="bi bi-arrow-clockwise"></i></a>
  <?php include 'src/includes/submenus/history_submenu.php'; ?>
  <a href="#" class="nav-link" title="Tasks"><i class="bi bi-list-task"></i></a>
  ...
  <a href="#" class="nav-link" title="Help"><i class="bi bi-question-circle-fill text-success"></i></a>
  <?php include 'src/includes/submenus/help_submenu.php'; ?>
    </nav>
